  ...
  return [
    ...
    },
    {
      ...
      config: {
        title: "List Modules",
        description:
          "List supported large-screen composition modules. Use ChartPanel for chart analysis, FreeformModule for arbitrary mixed content, and LayoutPlaceholder only for temporary pre-confirmation content-layout placeholders.",
        inputSchema: {},
        annotations: {
          readOnlyHint: true,
          destructiveHint: false,
    ...
    },
    {
      ...
      config: {
        ...
        description:
          "Generate editor component schemas from one explicit module input. Use ChartPanel for chart panels, FreeformModule for arbitrary mixed modules, and LayoutPlaceholder only for temporary pre-confirmation layout placeholders. Follow the selected module capability; layerRole controls content, decoration, and background ordering.",
