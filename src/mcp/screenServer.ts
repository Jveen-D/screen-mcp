  ...
  return [
    ...
    },
    {
      ...
      config: {
        ...
        description:
          "Generate complete editor component schemas from minimal AI props. SingleImage nodes with imageLayerRole='background' are sorted to the bottom layer; imageLayerRole='content' stays in the main content layer. Keep inputs concise and prefer SvgDecoration/style backgrounds unless image content is actually needed.",
        inputSchema: {
    ...
    },
    {
      ...
      config: {
        ...
        description:
          "Generate editor component schemas from one explicit module input. Use ChartPanel for chart panels and FreeformModule for arbitrary mixed modules. Inputs should be LLM-designed slots, not prompt-only templates; only SingleImage nodes with imageLayerRole='background' are sorted last.",
    ...
    },
    {
      ...
      config: {
        ...
        description:
          "Generate one editor-ready __Group__ module tree from explicit module slots. Supports common grouping.mode='semantic' and grouping.singleChildGroup=true. SingleImage backgrounds use imageLayerRole='background' and move to the bottom layer; imageLayerRole='content' stays in main content.",
        inputSchema: moduleInput,
        annotations: {
          readOnlyHint: false,
          destructiveHint: false,
