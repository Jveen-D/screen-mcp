...
export const barChartCapability: JsonObject = {
  ...
  aiWritableProps: [
    ...
    },
    {
      ...
      type: "object",
      description:
        "图表网格内边距配置，四边单位均为 px。AI 可适当调整 left/top/right/bottom 以适配标题和图例位置。",
      children: [
        {
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          defaultValue: "shadow",
          description: "坐标轴指示器类型。柱状对比通常使用 shadow。",
        },
        {
      ...
      children: [
        {
          ...
          type: "boolean",
          defaultValue: false,
          description: "是否把 option.color 转为纵向渐变。新建组件默认关闭。",
        },
        {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              type: "number|number[]",
              description: "背景柱圆角半径，支持数字或最多四项数组。",
            },
            {
  ...
  mergeRules: [
    ...
    "柱宽、边框、标签宽度、图例尺寸和渐变深度会按 capability 声明范围限制；内部 option.barStyle 由前端消费，不会传入 ECharts。",
  ],
  visualRules: [
    ...
    "柱体渐变默认关闭；只有在渐变确实有助于区分层次时才开启 option.barStyle.gradient，gradientDarken 建议 0.08–0.18。",
  ],
  examples: [
    {
      title: "柱状图配置示例",
