...
export const stackLineChartCapability: JsonObject = {
  ...
  aiWritableProps: [
    ...
    },
    {
      ...
      type: "string",
      description:
        "指标在图例、tooltip 中显示的名称，必须根据业务语义设置（如“客户数”“销售额”），不能保留默认值“value”。",
    },
    {
      path: "option.grid",
      type: "object",
  ...
  visualRules: [
    ...
    "AI 必须根据指标业务含义设置 chartData.indicator[0].fieldDataConfig.chartDisplayName（如“客户数”“销售额”），不能保留默认值“value”；该名称会显示在图例中。",
          ...
          indicator: [
            {
              fieldDataConfig: {
                calculateType: "SUM",
                chartDisplayName: "客户数",
              },
              fieldName: "value",
              fieldDisplayName: "客户数",
              fieldType: "DECIMAL",
            },
          ],
          constant: {
            data: [
              { name: "1月", type: "线上渠道", value: 120 },
              { name: "1月", type: "线下渠道", value: 80 },
              { name: "2月", type: "线上渠道", value: 132 },
              { name: "2月", type: "线下渠道", value: 98 },
              { name: "3月", type: "线上渠道", value: 101 },
              { name: "3月", type: "线下渠道", value: 142 },
              { name: "4月", type: "线上渠道", value: 134 },
              { name: "4月", type: "线下渠道", value: 90 },
            ],
            originalData: [
              { name: "1月", type: "线上渠道", value: 120 },
              { name: "1月", type: "线下渠道", value: 80 },
            ...
            fieldList: [
              ...
              { fieldName: "type", fieldDisplayName: "渠道", fieldType: "LONGTEXT" },
              { fieldName: "value", fieldDisplayName: "客户数", fieldType: "DECIMAL" },
            ],
          },
        },
        option: {
