...
function normalizeThreeDPieSeries(option: JsonObject): void {
...
function normalizeThreeDPieChartData(props: JsonObject): void {
...
function normalizeThreeDSettings(option: JsonObject): void {
...
export function normalizeThreeDPieChartProps(props: JsonObject): JsonObject {
