...
export const stackBarChartCapability: JsonObject = {
  ...
  aiWritableProps: [
    ...
    },
    {
      ...
      type: "object",
      description:
        "图表网格边距配置，控制堆叠柱状区域与容器边界的距离。AI 可适当调整 left/top/right/bottom 以适配标题和图例位置。",
      children: [
        {
          ...
          children: [
            {
              ...
              type: "boolean",
              description: "是否显示数据标签。堆叠柱状图默认开启。",
            },
            {
  ...
  aiForbiddenProps: [
    ...
    },
    {
      ...
      reason: "StackBarChart 不支持 barGap。",
    },
    {
      path: "option.series[i].barCategoryGap",
      reason: "StackBarChart 不支持 barCategoryGap。",
    },
    {
  ...
  visualRules: [
    ...
    "堆叠柱状图默认开启数据标签，若系列过多或数据密集导致标签重叠，可适当关闭或调整 label.position。",
