...
export const singleTextCapability: JsonObject = {
  ...
  aiWritableProps: [
    ...
    { path: "style.letterSpacing", type: "number", description: "字距。" },
    {
      ...
      range: [1, 2],
      description:
        "行高是 React/CSS 无单位倍率，不是 px。单行文本默认使用 1.35；不要填写 24、30 这类像素值。",
    },
    {
      path: "textOverflow",
      type: "enum",
      values: ["ellipsis", "clip", "visible"],
      description: "单行文本超出容器时的处理方式。",
    },
    {
      path: "verticalAlign",
      type: "enum",
      values: ["top", "center", "bottom"],
      description: "文本在固定高度容器内的垂直对齐方式。",
    },
  ...
  mergeRules: [
    ...
    "新建单行文本默认使用省略号、垂直居中和 1.35 倍行高；AI 可按语义调整容器高度和对齐。",
