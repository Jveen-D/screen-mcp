export const singleTextCapability = {
    componentName: "SingleText",
    displayName: "单行文本",
    description: "用于大屏标题、面板标题、指标名、单位、标签和短文本点缀的单行文本组件。",
    aiRole: "AI 负责文本内容、位置、尺寸、字体和视觉样式。MCP 负责补齐默认 datasource 与其余 props。组件层级由最终 schema 数组顺序决定。",
    requiredProps: [
        {
            path: "componentName",
            type: "string",
    ...
    aiWritableProps: [
        ...
        { path: "style.letterSpacing", type: "number", description: "字距。" },
        {
            ...
            type: "number",
            range: [1, 2],
            description: "行高是 React/CSS 无单位倍率，不是 px。单行文本默认使用 1.35；不要填写 24、30 这类像素值。",
        },
        {
            path: "textOverflow",
            type: "enum",
