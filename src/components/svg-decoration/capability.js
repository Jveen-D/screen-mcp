export const svgDecorationCapability = {
    ...
    displayName: "SVG装饰",
    description: "只用于大屏角标、线条、边框、科技纹理、图标和发光装饰的 SVG 组件，不能承载真实图表或业务文本。",
    aiRole: "AI 负责选择 preset 或填写安全的装饰性 svgContent，并设置位置、尺寸、颜色、翻转和发光。MCP 负责补齐默认 props，并会拒绝非装饰性 SVG。",
    requiredProps: [
        {
            path: "componentName",
            type: "string",
