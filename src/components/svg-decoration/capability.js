export const svgDecorationCapability = {
    componentName: "SvgDecoration",
    displayName: "SVG装饰",
    description: "只用于大屏角标、线条、边框、科技纹理、图标和发光装饰的 SVG 组件，不能承载真实图表或业务文本。AI 始终拥有设计权，可主动生成装饰性 SVG；仅当用户明确禁止装饰时才可省略。",
    aiRole: "AI 负责自主设计安全的装饰性 svgContent，并设置位置、尺寸、颜色、翻转和发光。只要有助于大屏视觉，就应主动用 custom svgContent 生成边框、角标、结构线、网格、扫描线或光效装饰；除非用户明确禁止装饰，否则不应留白底。MCP 负责补齐默认 props，并会清空不安全或非装饰性 svgContent，不会回退固定 preset 图标。",
    requiredProps: [
        {
            path: "componentName",
            type: "string",
    ...
    aiWritableProps: [
        ...
        },
        {
            path: "svgContent",
            type: "string",
            description: "完整 <svg>...</svg> 字符串。只能用于装饰线条、边框、角标、纹理或图标；不允许绘制饼图、柱图、折线图、信息卡、业务文本、数值、占比、标题或结论说明。",
        },
        {
            path: "svgFit",
            type: "enum",
    ...
    aiForbiddenProps: [
        ...
        },
        {
            ...
            reason: "真实图表必须使用 PieChart 等图表组件生成，不能用 SvgDecoration 手绘饼图、环形图、柱图或折线图。",
        },
        {
            path: "svgContent.text",
            reason: "业务文本、标题、数值、占比、摘要和结论必须使用 SingleText 等文本组件生成，不能写进 SVG。",
        },
        {
